...
#define FIREBASE_HOST "lpg-demo-default-rtdb.firebaseio.com"  
#define FIREBASE_AUTH "0Gc1FYiyAD3j1vzpVPZP7qI52eN70iY0ytkM3Mcz"  
...
void writeUsageData()
{
//  String date = myLocalTime.dateTime("d:m:Y");
//  String mytime = myLocalTime.dateTime("H:i");
